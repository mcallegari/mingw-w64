...
#define VerQueryValue __MINGW_NAME_AW(VerQueryValue)
  ...
  WINBOOL WINAPI VerQueryValueA(const LPCVOID pBlock,LPCSTR lpSubBlock,LPVOID *lplpBuffer,PUINT puLen);
  WINBOOL WINAPI VerQueryValueW(const LPCVOID pBlock,LPCWSTR lpSubBlock,LPVOID *lplpBuffer,PUINT puLen);
#endif
